...
public class BookRepository : IBookRepository
{
    ...
    public List<BookEditionDTO> Books(int BookId)
    {
        ...
        command.CommandText =
            @"SELECT books_editions.PK as Id, books.title as BookTitle, books_editions.edition_title as BEditionTitle,
        ...
        while (reader.Read())
        {
            ...
            {
                Id = (int)reader["Id"], BookTitle = (string)reader["BookTitle"],
                EditionTitle = (string)reader["BEditionTitle"], PublishingHouseName = (string)reader["PHName"],
                ReleaseDate = (DateTime)reader["Date"]
            });
        }
